...
const CrearCanalDeVenta = ({ token }) => {
  ...
  const handleCreateChannel = async (e) => {
    ...
    try {
      const result = await apiCall( `${process.env.REACT_APP_API_URL}/channels/create `, 'POST', {
